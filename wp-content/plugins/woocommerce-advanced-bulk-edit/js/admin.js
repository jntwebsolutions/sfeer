...
//		$('#pluginsettingstab-2').append('<div .customfieldclear style="clear:both;width:1px;height:1px;"><div>');
		...
		if(W3Ex.w3ex_show_id_search !== undefined)
		{
			...
			appendtext+= 'This will filter IDs 234,345,800 and 900 and also the range of IDs between 450 and 576 and the range of IDs between 900 and 1005. The range includes the limiting values, e.g. 450 and 576.';
			appendtext+= '</template>';
			appendtext+= '</td>';
			counter++;
		}
